...
public final class ReflectUtils {
    ...
    public static Object invokeStaticMethod(Class clz, String methodName) throws InvocationTargetException, IllegalAccessException {
        Method m = getMethod(clz, methodName);
